const initialProducts = [
  { 
    ...
    image: '/images/davidvendetta.jpg',
    description:
...
const users = [
  { id: 1, username: "user1", password: "pass1", isAdmin: false },
  { id: 2, username: "admin1", password: "adminpass", isAdmin: true },
